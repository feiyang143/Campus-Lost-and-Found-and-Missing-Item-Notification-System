	...
	<div class="rightinfo">
		...
		<table class="tablelist">
			...
			<tbody>
				<s:iterator value="listUser" var="userInfo">
					...
					<td><a href="user_deleteUser.action?userId=<s:property value='#userInfo.id' />">删除</a> <a href="#" class="tablelink">查看</a></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>
		...
		<div class="pagin">
			...
			<ul class="paginList">
				...
				<%
					// Get pageBean from session
					Object pageBeanObj = session.getAttribute("pageBean");
					int pageAllrecords = 1;
					if (pageBeanObj != null) {
						// Assuming Pages class has getTotalPages() method
						pageAllrecords = ((com.phn.entity.Pages)pageBeanObj).getTotalPages();
					}
				%>
				<%
			...
			<script type="text/javascript">  
				...
				var currentLi = "<s:property value="pageBean != null ? pageBean.currentPage : 1" />";
				var allRecord = <s:property value="pageBean != null ? pageBean.allRecords : 0" />;

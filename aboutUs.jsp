...
<script type="text/javascript">
	function getbiaoji() {
            ...
            var infoWindow = new BMap.InfoWindow("欢迎光临北京信息科技大学" + lng + lat, opts);  // 创建信息窗口对象
        ...
        function loand() {
            var map = new BMap.Map("container");
            var point = new BMap.Point(116.347100, 40.038009); //默认中心点
            var marker = new BMap.Marker(point);
            var opts = {
                width: 200,     // 信息窗口宽度
                height: 80,     // 信息窗口高度
            ...
            var infoWindow = new BMap.InfoWindow("欢迎光临北京信息科技大学", opts);  // 创建信息窗口对象
		...
		<div
				...
				<p style="line-height: 2em;">
					<span style=";font-size:14px;font-family:'宋体'">&nbsp;&nbsp;&nbsp;
							 本站旨在为方便失主寻找丢失物品、拾主归还捡拾物品和减轻失物招领中心的管理员的工作负担，以及发扬拾金不昧的美好品德。</span>
				</p>
				<p style="line-height: 2em;">
					<span style=";font-size:14px;font-family:'宋体'">&nbsp;&nbsp;&nbsp;
			...
			<div
				...
				<p style="text-align: center;font-size: 24px;">
					<span
						style=";color:rgb(0,0,0);font-weight:normal;font-style:normal;font-size:24px;font-family:'宋体'"></span>
				</p>

				<p
					style=";text-autospace:ideograph-other;text-align:left;line-height:22px">
					<span
						style=";color:rgb(0,0,0);font-weight:normal;font-style:normal;font-size:14px;font-family:'宋体'"> </span><span
						style=";color:rgb(0,0,0);font-weight:normal;font-style:normal;font-size:14px;font-family:'宋体'">&nbsp;&nbsp;</span><span

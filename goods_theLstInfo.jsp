		...
		<div class="theLostInfo_comment">
			<form action="comment_NewInfo.action" method="post">
				...
				<textarea name="comment.commentcontent" class="commentLostDescribe"
					...
					rows="3"></textarea>
				 <div style="height: 56px;line-height:56px;"><input type="submit" value="提供线索/我已找到" style="width: 150px;height: 30px;background-color: #4CAF50;color: white;border: none;border-radius: 4px;cursor: pointer;">&nbsp;&nbsp;请文明留言,不得违反国家法律法规！</div>
			</form>
		</div>
